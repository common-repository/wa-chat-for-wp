				...
				<?php if ( have_rows( 'team_members', 'option' ) ): ?>
					...
					<?php while ( have_rows( 'team_members', 'option' ) ): the_row();
                        ...
                        <div class="wa__popup_content_item ">
                            <a target="_blank"
                               href="https://web.whatsapp.com/send?phone=<?php echo $wac_phoneNumber; ?>&amp;text=Hello, I need help from you. Here is link <?php echo get_permalink(); ?>"
		...
		<?php while ( have_rows( 'team_members', 'option' ) ): the_row();
            ...
            <div class="nta-woo-products-button">
                <div id="nta-wabutton-9653" style="margin: 10px 0px;"><a
                            href="https://api.whatsapp.com/send?phone=<?php echo $wac_phoneNumber; ?>&amp;text=Hello, I need help from you. Here is link <?php echo get_permalink(); ?>"
